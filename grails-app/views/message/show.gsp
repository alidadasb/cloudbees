	...
	<body>
		...
		<div id="show-message" class="content scaffold-show" role="main">
			...
			<ol class="property-list message">
				...
				<g:if test="${messageInstance?.posted}">
				<li class="fieldcontain">
					<span id="posted-label" class="property-label"><g:message code="message.posted.label" default="Posted" /></span>
					
						<span class="property-value" aria-labelledby="posted-label"><g:formatDate date="${messageInstance?.posted}" /></span>
